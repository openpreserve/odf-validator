...
<schema xmlns="http://purl.oclc.org/dsdl/schematron">
  ...
  <pattern id="POL_6">
    ...
    <rule context="//office:document-content">
      <assert id="POL_6.1" role="INFO" test="count(//draw:object) &lt; 1">The spreadsheet MAY reference Embedded OpenDocument objects.</assert>
      <assert id="POL_6.2" role="INFO" test="count(//draw:object-ole) &lt; 1">The spreadsheet MAY reference OLE objects.</assert>
    </rule>
  </pattern>
</schema>