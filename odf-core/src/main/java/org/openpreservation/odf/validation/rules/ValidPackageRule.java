...
class ValidPackageRule extends AbstractRule {
    ...
    static final ValidPackageRule getInstance(final Severity severity, final boolean isExtended) {
    ...
    public MessageLog check(final OpenDocument document) throws ParseException {
        ...
        try {
            ...
            OdfValidator validator = OdfValidators.getOdfValidator(this.isExtended);
