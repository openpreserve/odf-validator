...
"%JAVACMD%" -Dfile.encoding=UTF8 -XX:+IgnoreUnrecognizedVMOptions -Dapp.name="ODF Validator" -jar odf-apps\target\odf-validator-${project.version}-jar-with-dependencies.jar %CMD_LINE_ARGS%
