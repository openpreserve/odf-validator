...
public class EncodingsTest {
    ...
    public void testUtf8() throws IOException {
        ...
        InputStream is = ClassLoader.getSystemResourceAsStream(TestData.UTF8_BOM_FILE);
        byte[] bytes = new byte[100];
        int read = is.read(bytes);
        assertEquals(3, read);
        assertSame(Encodings.UTF_8, Encodings.fromRepresentation(bytes));
        is = ClassLoader.getSystemResourceAsStream(TestData.UTF8_BOM_PI_FILE);
        read = is.read(bytes);
    ...
    public void testUtf16Le() throws IOException {
        ...
        InputStream is = ClassLoader.getSystemResourceAsStream(TestData.UTF16LE_BOM_FILE);
        byte[] bytes = new byte[100];
        int read = is.read(bytes);
        ...
        is = ClassLoader.getSystemResourceAsStream(TestData.UTF16LE_BOM_PI_FILE);
        read = is.read(bytes);
    ...
    public void testUtf16Be() throws IOException {
        ...
        InputStream is = ClassLoader.getSystemResourceAsStream(TestData.UTF16BE_BOM_FILE);
        byte[] bytes = new byte[100];
        int read = is.read(bytes);
        byte[] testBytes = new byte[read];
        System.arraycopy(bytes, 0, testBytes, 0, read);
        assertSame(Encodings.UTF_16_BE, Encodings.fromRepresentation(testBytes));
        is = ClassLoader.getSystemResourceAsStream(TestData.UTF16BE_BOM_PI_FILE);
        read = is.read(bytes);
        testBytes = new byte[read];
        System.arraycopy(bytes, 0, testBytes, 0, read);
        assertSame(Encodings.UTF_16_BE, Encodings.fromRepresentation(testBytes));
